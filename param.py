...
parser.add_argument("--n_layer", type=int, default=3, help="number of layers of the policy network (default: 3)")

parser.add_argument("--model_exists", type=bool, default=False, help="whether to train with an existing model (default: False)")
parser.add_argument("--ex_model_name", type=str, default=None, help="the existed model name (default:None)")
